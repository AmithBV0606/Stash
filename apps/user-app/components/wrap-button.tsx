...
const WrapButton: React.FC<WrapButtonProps> = ({ className, children }) => {
  return (
    <div className="w-[300px] mx-auto md:mx-0">
      <Dialog>
        <DialogTrigger asChild>
          <div
            className={cn(
              "group cursor-pointer border group border-[#3B3A3A] bg-[#151515] gap-2  h-[64px] flex items-center justify-between p-[11px] rounded-full",
              className
            )}
          >
            <div className="border border-[#3B3A3A] bg-[#ff3f17]  h-[43px] w-[200px] rounded-full flex items-center justify-center text-white">
            ...
            <div className="text-[#3b3a3a] group-hover:ml-2  ease-in-out transition-all size-[36px] flex items-center justify-center rounded-full border-2 border-[#3b3a3a]  ">
              <ArrowRight
                size={18}
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <DialogHeader>
              ...
              <DialogDescription className="sm:text-center">
                We just need few details of yours from Google to get you
                started.
              </DialogDescription>
            </DialogHeader>
          </div>
