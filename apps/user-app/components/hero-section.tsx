            ...
            <div className="lg:flex lg:items-center lg:gap-12">
              <div className="relative z-10 mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                ...
                >
                  ...
                  <span className="text-sm">Explore The Stash Application</span>
                ...
                <p className="mt-8">
                  Experience the simplicity of effortless transactions, powered
                  by Stash. Inspired by PayTM. Reimagined for you.
                </p>

                <div>
                  <WrapButton className="mx-auto my-10 max-w-lg lg:my-12 lg:ml-0 lg:mr-auto">
                    Get Started
                  </WrapButton>
